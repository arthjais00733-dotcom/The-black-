/* =========================================
   THE BLACK — CORE LOGIC ENGINE (V2.0)
   ========================================= */
...
// --- DYNAMIC BATCH PRACTICE & RESULTS ---
...
function renderArchiveBatches(list) {
  ...
  for(let i=0; i<totalBatches; i++) {
      ...
      // NEW: Quick Test Button injected inside the open folder
