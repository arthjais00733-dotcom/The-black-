/* =========================================
   THE BLACK — CORE LOGIC ENGINE (V2.1)
   Endless Loop Fixed / Test Engine Unified
   ========================================= */
...
// Practice Mode Trackers (The Test Engine)
let practiceQueue = [];
...
function goRoot() { 
  currentCategory = ''; wordData = []; updateStats(); showScreen('category'); 
}
...
// --- UNIFIED TEST ENGINE (BATCH PRACTICE & RESULTS) ---
...
function startPractice(batchIndex) {
    ...
    // Fisher-Yates Master Shuffle for the Test
...
function retryWrongWords() {
    ...
    // Shuffle the wrong words before retrying
...
// Fixed: This is the ONLY practice rendering function now
